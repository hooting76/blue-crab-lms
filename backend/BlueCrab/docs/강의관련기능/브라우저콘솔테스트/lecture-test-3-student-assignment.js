...
console.log('await getMyAssignments()      // 내 과제 목록');
console.log('await getAssignmentDetail()   // 과제 상세 조회');
console.log('await markAsSubmitted()       // 과제 제출 완료 표시');
console.log('await cancelSubmission()      // 과제 제출 취소');
