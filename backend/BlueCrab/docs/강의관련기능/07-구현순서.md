...
**작업 순서**:
1. [ ] **SQL 실행**: `ALTER TABLE USER_TBL ADD COLUMN LECTURE_EVALUATIONS LONGTEXT`
2. [ ] **JPA 엔티티 수정**: User.java에 LECTURE_EVALUATIONS 필드 추가
3. [ ] **Repository 테스트**: 데이터 저장/조회 확인
4. [ ] **완결 확인**: 평가 데이터 CRUD 동작 검증
...
**작업 순서**:
1. [ ] **SQL 실행**: LEC_TBL에 필요한 컬럼 추가
2. [ ] **JPA 엔티티 생성**: LectureTbl.java 완성
3. [ ] **Repository 생성**: LectureTblRepository.java
4. [ ] **Service 기본 구현**: 강의 CRUD 메서드
5. [ ] **완결 확인**: 강의 생성/조회/수정/삭제 테스트
...
**작업 순서**:
1. [ ] **SQL 실행**: CREATE TABLE ENROLLMENT_EXTENDED_TBL
2. [ ] **인덱스 생성**: 외래 키 및 성능 인덱스
3. [ ] **JPA 엔티티 생성**: EnrollmentExtendedTbl.java
4. [ ] **Repository 생성**: EnrollmentExtendedRepository.java
5. [ ] **Service 구현**: 수강신청/출결/성적 관리 로직
6. [ ] **JSON 처리 유틸리티**: 수강 데이터 변환 클래스
7. [ ] **완결 확인**: 수강신청 → 출결 → 성적 전체 플로우 테스트
...
**작업 순서**:
1. [ ] **SQL 실행**: CREATE TABLE ASSIGNMENT_EXTENDED_TBL
2. [ ] **인덱스 생성**: 외래 키 및 성능 인덱스
3. [ ] **JPA 엔티티 생성**: AssignmentExtendedTbl.java
4. [ ] **Repository 생성**: AssignmentExtendedRepository.java
5. [ ] **Service 구현**: 과제 생성/제출/채점 로직
6. [ ] **JSON 처리 유틸리티**: 과제 데이터 변환 클래스
7. [ ] **완결 확인**: 과제 생성 → 제출 → 채점 전체 플로우 테스트
